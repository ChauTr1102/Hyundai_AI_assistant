...
def main():
    ...
    prompt_template = PromptTemplate.from_template(
        ...
        Nếu có thể bạn hãy đưa thêm phần tóm tắt nội dung qua mỗi lần tìm được và đưa cho tôi một thông tin gì đó hay để đưa ra cho khách hàng
    ...
    if prompt := st.chat_input("Bạn cần tôi giúp gì nào?"):
